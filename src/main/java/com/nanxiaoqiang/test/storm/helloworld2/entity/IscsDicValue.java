package com.nanxiaoqiang.test.storm.helloworld2.entity;
...
public class IscsDicValue implements Serializable {
	...
	/**
	 * 文件位置(文件位置) version 0.5.0beta加入，可能会遗弃
	 */
	...
	public boolean equals(Object other) {
		...
		if (other == null)
			return false;
		if (!(other instanceof IscsDicValue))
			return false;
		final IscsDicValue obj = (IscsDicValue) other;
		return new EqualsBuilder().append(this.id, obj.id)
				.append(this.value, obj.value)
				.append(this.updateTime, obj.updateTime).isEquals();
	}
